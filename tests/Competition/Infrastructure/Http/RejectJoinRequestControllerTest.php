...
final class RejectJoinRequestControllerTest extends WebTestCase
{
    ...
    public function it_rejects_a_join_request_when_requested_by_the_captain(): void
    {
        ...
        $client->request('POST', "/competitions/{$competition->getId()->value}/teams/t1/join-requests/applicant@example.com/reject", server: [
    ...
    public function it_returns_401_without_a_token(): void
    {
        ...
        $client->request('POST', "/competitions/{$competition->getId()->value}/teams/t1/join-requests/applicant@example.com/reject");
