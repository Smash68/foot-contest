...
final class ApproveJoinRequestHandlerTest extends TestCase
{
    ...
    public function it_approves_a_pending_join_request_when_requested_by_the_captain(): void
    {
        ...
        $handler(new ApproveJoinRequestCommand('c1', 't1', 'applicant@example.com', 'captain@example.com'));

        self::assertCount(2, $competition->getTeamRoster(new TeamId('t1')));
    }
    ...
    public function it_rejects_approval_for_an_unknown_competition(): void
    {
        ...
        $handler(new ApproveJoinRequestCommand('unknown', 't1', 'applicant@example.com', 'captain@example.com'));
    }
    ...
    public function it_rejects_approval_by_a_player_who_is_not_the_captain(): void
    {
        ...
        $handler(new ApproveJoinRequestCommand('c1', 't1', 'applicant@example.com', 'someone-else@example.com'));
    }
}
