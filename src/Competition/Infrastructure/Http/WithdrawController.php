...
final class WithdrawController
{
    ...
    public function __invoke(string $competitionId, string $teamId, #[CurrentUser] UserInterface $actor): Response
    {
        $this->bus->dispatch(new WithdrawCommand($competitionId, $teamId, $actor->getUserIdentifier()));
